...
const TestCard = ({ test }) => (
  <div className="tipBg flex max-w-xs flex-col items-center justify-center pb-8 lg:max-w-xl">
    {/* Icon circle */}
    <div className="pt-12">
    ...
    <div className="flex flex-1 flex-col items-center justify-items-center px-8 pt-12">
      ...
      <Link href={`/journey/test/${test.slug.current}`}>
        <button className="text-regular text-grey-50 hover:bg-dark-blue flex w-[263.065px] cursor-pointer flex-row items-center justify-center rounded-[20px] bg-blue-800 p-[10px] transition">
          Read details →
        </button>
      </Link>
    </div>
      ...
      <main className="font-galosText">
        ...
        <section className="grid-bg section-shadow rounded-2xl py-[160px] shadow-[0_0_20px_0_rgba(0,95,255,0.40)]">
          <div className="container-main">
            ...
            <div className="mx-auto mt-8 grid max-w-[1300px] grid-cols-1 justify-items-center gap-8 md:grid-cols-2 lg:grid-cols-3">
              {tests?.map((test) => (
        ...
        <section
          id="reflections"
          className="section-shadow mb-2 rounded-2xl bg-white py-[80px]"
        >
          <div className="container-main">
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
              {reflections.map((reflection) => (
                ...
                >
                  ...
                  <h4 className="heading-md mb-4 flex-1 text-blue-800">
                    {reflection.title}
                  </h4>
