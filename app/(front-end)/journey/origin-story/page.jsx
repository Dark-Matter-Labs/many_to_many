  ...
  return (
    <>
      ...
      <section className={'heading ' + styles.heroOrigin}>
        <h1 className="ml-4 text-blue-800 sm:ml-8 sm:ml-40">
          The Origin Story
        </h1>
      </section>
            ...
            <div className="grid grid-cols-1 gap-x-40 gap-y-30 sm:grid-cols-2">
              ...
              <div>
                <p className="text-regular text-grey-600">
                  ...
                  organising, and legal architecture within complex
                  collaborations. The image below illustrates the full ecosystem
                  explored, providing context for Many-to-Many's development.
                </p>
              </div>
            </div>
