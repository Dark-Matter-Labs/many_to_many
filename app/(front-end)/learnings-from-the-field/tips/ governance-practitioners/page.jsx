...
export const metadata = {
  title: 'Top Tips for Complex Governance Practitioners and Process Stewards - Many-to-Many System',
};
    ...
    <>
      ...
      <main>
        ...
        <div className="container-main py-4">
          <Link href="/learnings-from-the-field" className="text-regular text-grey-600 hover:text-blue-800">
          ...
          <div className="container-main">
            <div className="flex items-center justify-between">
              <div className="flex-1">
                ...
                <p className="text-regular text-white max-w-4xl">
          ...
          <div className="container-main">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
              ...
              <div className="space-y-6">
                <h2 className="heading text-blue-800">1. Start with relationships</h2>
              ...
              <div className="space-y-6">
                ...
                <ul className="text-regular text-grey-600 space-y-4 list-disc list-inside">
                  <li>
              ...
              {/* Tip 2 */}
              <div className="space-y-6">
                <h2 className="heading text-blue-800">2. Hold space for conflict, don't avoid it</h2>
                <blockquote className="text-regular text-orange-800 italic">
              ...
              {/* Tip 3 */}
              <div className="space-y-6">
                <h2 className="heading text-blue-800">3. Build learning into the system from the start</h2>
                <blockquote className="text-regular text-orange-800 italic">
              ...
              {/* Tip 4 */}
              <div className="space-y-6">
                <h2 className="heading text-blue-800">4. Practise and iterate</h2>
              ...
              {/* Tip 5 */}
              <div className="space-y-6">
                <h2 className="heading text-blue-800">5. Make the invisible visible</h2>
                <blockquote className="text-regular text-orange-800 italic">
        ...
        <section className="bg-yellow-100 py-20">
          <div className="container-main">
            <h2 className="heading text-blue-800 mb-6">And remember... Don't do it alone.</h2>
        ...
        <section className="py-20 bg-white">
          <div className="container-main flex justify-center gap-8">
            <Link href="/learnings-from-the-field">
              <button className="px-8 py-4 bg-blue-800 text-white rounded-full hover:bg-blue-700 transition-colors">
                ← Previous
              </button>
            </Link>
            <Link href="/learnings-from-the-field">
