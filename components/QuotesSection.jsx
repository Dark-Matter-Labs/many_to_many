                ...
                <div className="text-center">
                  <p className="text-grey-600 text-sm leading-relaxed">
                    <span className="font-regular text-orange-800">
                      "It's a bit like an alternative to both traditional (e.g.
                      governance system) and the COP (a legal framework,
                      specifically for [life-affirming] Markets."
                    </span>
                  </p>
            ...
            <div className="relative">
              <div className="flex h-[320px] w-[320px] items-center justify-center rounded-full bg-white p-10 shadow-[0_10px_40px_rgba(0,0,0,0.08)]">
                <div className="text-center">
                  <p className="text-grey-600 text-sm leading-relaxed">
                    <span className="font-regular text-orange-800">
                      "There are lots of people out there doing collaborative
                      work, but what makes this really different is the people
                      working component."
                    </span>
                  </p>
                  <p className="text-grey-600 mt-3 text-xs">
