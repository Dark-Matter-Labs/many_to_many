...
export const Navbar = ({ activePage, transparent = false }) => {
  ...
  return (
    ...
    >
      <div className="mx-auto flex w-full max-w-[1351px] items-center justify-between rounded-[100px] bg-[#FBFBFF]/90 px-4 py-3 shadow-[0_2px_2px_0_rgba(255,255,255,0.85)_inset,0_-3px_4px_0_rgba(255,255,255,0.50)_inset,0_4px_4px_0_rgba(105,105,105,0.25),0_4px_20px_0_rgba(137,137,137,0.25)_inset] md:h-[87px] md:px-8 relative">
        <Link
          href="/"
        ...
        {isOpen && (
          <div className="absolute left-3 right-3 top-[calc(100%+12px)] z-50 rounded-2xl bg-[#FBFBFF] p-2 shadow-[0_2px_2px_0_rgba(255,255,255,0.85)_inset,0_-3px_4px_0_rgba(255,255,255,0.50)_inset,0_4px_4px_0_rgba(105,105,105,0.25),0_4px_20px_0_rgba(137,137,137,0.25)_inset] lg:hidden">
            {navLinks.map((link) => (
              <Link
                key={link.url}
                href={link.url}
                ...
                className={
                  'block rounded-md px-4 py-3 font-galosText text-[14px] tracking-[-0.308px] ' +
                  (isActive(link.url, link.title)
                    ? 'text-[#005FFF]'
